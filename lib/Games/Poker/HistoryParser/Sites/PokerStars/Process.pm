package Games::Poker::HistoryParser::Sites::PokerStars::Process;
...
sub process{
    ...
    if( $game && ( $game eq 'HE' || $game eq 'OH' ) ){
        ...
        require Games::Poker::HistoryParser::Sites::PokerStars::FlopGames;
        return Games::Poker::HistoryParser::Sites::PokerStars::FlopGames::parse_hand( $history, 
                                                         $game, 
                                                         $game_display, 
                                                         $hilo_flag, 
                                                         $site, 
        ...
        require Games::Poker::HistoryParser::Sites::PokerStars::StudGames;
        return Games::Poker::HistoryParser::Sites::PokerStars::StudGames::parse_hand( $history, 
                                                         $game, 
                                                         $game_display, 
                                                         $hilo_flag, 
                                                         $site, 
...
sub _determine_game{
    ...
    return 'HE', 'Hold\'em', 0              if ( $history =~ m/Hold\'em/i );
