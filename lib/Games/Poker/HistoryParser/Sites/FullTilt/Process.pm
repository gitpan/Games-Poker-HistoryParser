package Games::Poker::HistoryParser::Sites::FullTilt::Process;
...
sub process{
    ...
    if( $game && ( $game eq 'HE' || $game eq 'OH' ) ){
        ...
        require Games::Poker::HistoryParser::Sites::FullTilt::FlopGames;
        return Games::Poker::HistoryParser::Sites::FullTilt::FlopGames::parse_hand( $history, 
                                                         $game, 
                                                         $game_display, 
                                                         $hilo_flag, 
                                                         $site, 
...
Sites::FullTilt::Process - Primary interface for FullTilt hand histories.
